...
namespace Tbh
{
    ...
    {
        private readonly Dictionary<int, HotKeyCallBackHanlder> _keymap = new Dictionary<int, HotKeyCallBackHanlder>();
        ...
        private static partial bool RegisterHotKey(IntPtr hWnd, int id, int modifiers, EKey vk);
        ...
        private static partial short GlobalAddAtomW(string lpString);

        /// <summary>
        /// 在表中搜索全局原子
        /// </summary>
        [LibraryImport("kernel32.dll", SetLastError = true, StringMarshalling = StringMarshalling.Utf16)]
        public static partial short GlobalFindAtomW(string lpString);

        /// <summary>
        /// 在表中删除全局原子
        /// </summary>
        [LibraryImport("kernel32.dll", SetLastError = true, StringMarshalling = StringMarshalling.Utf16)]
        private static partial short GlobalDeleteAtom(string nAtom);
        ...
        {
            int id = GlobalAddAtomW("Taskbar Hider");
