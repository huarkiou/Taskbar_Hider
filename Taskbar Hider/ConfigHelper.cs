...
{
    internal HOT_KEY_MODIFIERS Modifiers { get; set; } = HOT_KEY_MODIFIERS.MOD_ALT;
    internal VIRTUAL_KEY VKey { get; set; } = VIRTUAL_KEY.VK_F2;
    internal bool ShowTaskbarOnStartup { get; set; } = true;
}
